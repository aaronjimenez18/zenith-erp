      ...
      <div className="glass-card p-10 rounded-[28px] w-full max-w-sm relative z-10">
        {verified && (
          <div className="mb-4 rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-center">
            <p className="text-sm font-semibold text-green-800">Pago aceptado</p>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div className="space-y-2">
            <label htmlFor="login-email" className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Correo</label>
            <input
              id="login-email"
              type="email"
          ...
          <div className="space-y-2">
            <label htmlFor="login-password" className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Contraseña</label>
            <input
              id="login-password"
              type="password"
              placeholder="••••••••"
